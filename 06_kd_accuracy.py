...
y=qud_lwhite(PROTEIN_CONC, L0_CONC, x_axis, REDVOL, WHITEVOL, 1.0)
...
for conc_i, conc in enumerate(lwhite_concs_to_get_kds_from):
    ...
    lowKd=qud_Kd_from_lwhite(conc*0.975,PROTEIN_CONC,L0_CONC,REDVOL,WHITEVOL,1.0)
    highKd=qud_Kd_from_lwhite(conc*1.025,PROTEIN_CONC,L0_CONC,REDVOL,WHITEVOL,1.0)
    ax.axvline(lowKd)
    ax.axvline(highKd)
