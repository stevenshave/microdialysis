...
#  - pt is the experimentally determined ratio between compound concentration
#     in the red versus white chambers.
...
print(f"Kd={qud_Kd_from_pt(**system_parameters):.4f}")
