...
ax.plot((PROTEIN_CONC/x_axis)+1, 'k--', label='p-value (Simplified Weidemann equation)')
ax.plot(x_axis,y[0]/y[1], 'k', label='p-value')

ax.set_xlim(XAXIS_BEGINNING,XAXIS_END)
ax.grid()
ax.set_ylim(0,10)
ax.hlines(1,XAXIS_BEGINNING,XAXIS_END, linestyle='dotted', label="Equlibrium (p-value=1)")
ax.legend()
ax.set_ylabel(r"p$_t$")
